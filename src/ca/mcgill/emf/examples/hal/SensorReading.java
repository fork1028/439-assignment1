 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.SensorReading#getReadingValue <em>Reading Value</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.SensorReading#getSensorTimestamp <em>Sensor Timestamp</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.SensorReading#getActivitylog <em>Activitylog</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.SensorReading#getSensordevice <em>Sensordevice</em>}</li>
 * </ul>
 *
...
public interface SensorReading extends EObject {
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getSensorReading_ReadingValue()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.examples.hal.SensorReading#getReadingValue <em>Reading Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getSensorReading_SensorTimestamp()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.examples.hal.SensorReading#getSensorTimestamp <em>Sensor Timestamp</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.mcgill.emf.examples.hal.ActivityLog#getSensorreading <em>Sensorreading</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
