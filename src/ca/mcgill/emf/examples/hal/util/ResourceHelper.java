...
public class ResourceHelper {
	...
	/**
	 * Initializes the resource set and registers the default XMI factory for any
	 * file extension.
	 */
	private void initializeResourceSet() {
		...
		/**
		 * Register default XMI factory implementation for any extension. Requires
		 * bundle org.eclipse.emf.ecore.xmi.
		 */
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("*", new XMIResourceFactoryImpl());
	}

	/**
	 * Adds a specific resource factory for the given file extension to the resource
	 * factory registry. This allows to use custom resource factories that usually
	 * extend {@link org.eclipse.emf.ecore.resource.impl.ResourceFactoryImpl}.
	 * 
