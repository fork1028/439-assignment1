 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.example.hal.ActivityLog#getLogId <em>Log Id</em>}</li>
 *   <li>{@link ca.mcgill.emf.example.hal.ActivityLog#getSensorreading <em>Sensorreading</em>}</li>
 *   <li>{@link ca.mcgill.emf.example.hal.ActivityLog#getControlcommand <em>Controlcommand</em>}</li>
 * </ul>
 *
 * @see ca.mcgill.emf.example.hal.HalPackage#getActivityLog()
 * @model
 * @generated
 */
public interface ActivityLog extends EObject {
	 ...
	 * @see #setLogId(String)
	 * @see ca.mcgill.emf.example.hal.HalPackage#getActivityLog_LogId()
	 * @model
	 * @generated
	 */
	String getLogId();
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.example.hal.ActivityLog#getLogId <em>Log Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.mcgill.emf.example.hal.SensorReading#getActivitylog <em>Activitylog</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sensorreading</em>' reference list.
	 * @see ca.mcgill.emf.example.hal.HalPackage#getActivityLog_Sensorreading()
	 ...
	 * It is bidirectional and its opposite is '{@link ca.mcgill.emf.example.hal.ControlCommand#getActivitylog <em>Activitylog</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Controlcommand</em>' reference list.
	 * @see ca.mcgill.emf.example.hal.HalPackage#getActivityLog_Controlcommand()
