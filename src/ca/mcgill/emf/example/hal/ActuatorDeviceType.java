 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.example.hal.ActuatorDeviceType#getActuatorTypeName <em>Actuator Type Name</em>}</li>
 *   <li>{@link ca.mcgill.emf.example.hal.ActuatorDeviceType#getActuatordevice <em>Actuatordevice</em>}</li>
 * </ul>
 *
 * @see ca.mcgill.emf.example.hal.HalPackage#getActuatorDeviceType()
 * @model
 * @generated
 */
public interface ActuatorDeviceType extends EObject {
	 ...
	 * @see ca.mcgill.emf.example.hal.HalPackage#getActuatorDeviceType_ActuatorTypeName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.example.hal.ActuatorDeviceType#getActuatorTypeName <em>Actuator Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link ca.mcgill.emf.example.hal.ActuatorDevice#getActuatordevicetype <em>Actuatordevicetype</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Actuatordevice</em>' reference.
	 * @see #setActuatordevice(ActuatorDevice)
	 * @see ca.mcgill.emf.example.hal.HalPackage#getActuatorDeviceType_Actuatordevice()
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.example.hal.ActuatorDeviceType#getActuatordevice <em>Actuatordevice</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
